    ...
    <nav>
        ...
        <?php if (isset($_SESSION['user'])): ?>
            <?php if ((int)$_SESSION['user']['role'] === 1): ?>
                <a href="<?= BASE_URL ?>/home/instructorDashboard"><i class="fas fa-chart-line"></i>Dashboard</a>
                <a href="<?= BASE_URL ?>/course/my_courses"><i class="fas fa-book"></i> Khóa học của tôi</a>
            <?php endif; ?>
            <?php if ((int)($_SESSION['user']['role'] === 0)): ?>
                <a href="<?= BASE_URL ?>/home/studentDashboard"><i class="fas fa-chart-line"></i> Dashboard</a>
            <?php endif; ?>
